...
const cubeRotation = config('Cube Rotation', val([2.47,0.56,-0.15], rotation3D({ min: -3.14, max: 3.14, step: 0.01 })))

const cubeScale = config('Cube Scale', val([1.4,4.99,1.4], scale3D({ min: 0.2, max: 3, step: 0.05 })))
